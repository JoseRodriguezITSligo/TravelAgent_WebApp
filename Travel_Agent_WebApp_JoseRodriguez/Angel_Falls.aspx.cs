...
namespace Travel_Agent_WebApp_JoseRodriguez
{
    public partial class WebForm2 : System.Web.UI.Page
    {
        ...
        protected void btnBookButton_Click(object sender, EventArgs e)
        {
            ...
            else {// if no option for the tours is checked
                //Show error message
                lblErrorMsg.Text = "No option has been selected from the tours list. Please, tick off one tour at least.";
                ErrorMsgConfig();
            }// End of if if else statement to check a tour has been ticked off
            
        }//End of book button click event handler

        //Event handler for currency selection changed
